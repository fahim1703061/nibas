...
function RentOut() {
  ...
  const handleSubmit = async (event) => {
    ...
    form.append('pricePerDuration',sellHome.pricePerDuration)
    form.append('duration',sellHome.duration)
    ...
    try {
      ...
      const { data }= await axios.post('/api/rentout/', form, { headers })
      console.log(data)
        setIsSubmitted(true);
        setTimeout(function(){
                ...
                <Row className=''>
                    <Col >
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group controlId=''>
                                    <Form.Label>Price/duration Tk.</Form.Label>
                                    <Form.Control
                                        required
                                        type='number'
                                        name='pricePerDuration'
                                        placeholder='Enter pricePerDuration'
                                        value={sellHome.pricePerDuration}
                                        onChange={(e) => setSellHome({
                                          ...sellHome,                   //object spreading src: sumit saha react hooks
                                          'pricePerDuration' : e.target.value
                                        })}
                                    >
                                    </Form.Control>
                                </Form.Group>
      ...
      <Row>
        ...
        <Col md={3}>
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
            price/{sellHome.duration}: Tk. {sellHome.pricePerDuration}
            </ListGroup.Item>
          </ListGroup>
        </Col>
        ...
        <Col md={3}>
          <Card>
            <ListGroup variant='flush'>
              <ListGroup.Item>
                <Row>
                  <Col>price/{sellHome.duration}:</Col>
                  <Col>
                    <strong> Tk. {sellHome.pricePerDuration}</strong>
                  </Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
