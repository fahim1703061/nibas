...
function MyRentOutList() {
    ...
    useEffect(() => {
        ...
        async function fetchmylists(){
            ...
            const { data } = await axios.get('/api/rentout/mylist/',{ headers })
            setmylists(data)
            console.log(mylists);
            ...
            // useEffect(() => {
                async function deleteHome(){
                    ...
                    if (window.confirm('Are you sure you want to delete this home?')) {
                        ...
                        const {data} = await axios.delete(`/api/rent/delete/${id}/`,{ headers })
                        setDeleteMsg(data)
                ...
                <tbody>
                    {mylists.map(mylist => (
                        <tr key={mylist._id}>
                            ...
                            <td>{mylist.pricePerDuration} Tk/{mylist.duration}</td>
                            ...
                            <td>
                                <LinkContainer to={`/rent/${mylist._id}/`}>
